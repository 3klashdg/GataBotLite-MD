...
const smsCreB = () => { return 'اسمي هو لايت'}
...
//propietario(a).js
const smsBioEd1 = () => { return `*اكتب النص الذي تريد عرضه في سيرة* ${ℓɪɢнτ вστ}`}
...
//propietario(a).js
const smsNameEd1 = () => { return `*اكتب النص الذي تريد عرضه باسم المستخدم* ${ℓɪɢнτ вστ}`}
